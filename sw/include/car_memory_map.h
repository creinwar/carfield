...
#define CAR_SAFETY_ISLAND_BOOTADDR_OFFSET    0x00000000
#define CAR_SAFETY_ISLAND_FETCHEN_OFFSET     0x00000004
#define CAR_SAFETY_ISLAND_BOOTMODE_OFFSET    0x0000000C
#define CAR_SAFETY_ISLAND_CORESTATUS_OFFSET  0x00000008
...
#define CAR_SAFETY_ISLAND_BOOTADDR_ADDR      (CAR_SAFETY_ISLAND_SOC_CTRL_ADDR + CAR_SAFETY_ISLAND_BOOTADDR_OFFSET)
#define CAR_SAFETY_ISLAND_FETCHEN_ADDR       (CAR_SAFETY_ISLAND_SOC_CTRL_ADDR + CAR_SAFETY_ISLAND_FETCHEN_OFFSET)
#define CAR_SAFETY_ISLAND_BOOTMODE_ADDR      (CAR_SAFETY_ISLAND_SOC_CTRL_ADDR + CAR_SAFETY_ISLAND_BOOTMODE_OFFSET)
#define CAR_SAFETY_ISLAND_CORESTATUS_ADDR    (CAR_SAFETY_ISLAND_SOC_CTRL_ADDR + CAR_SAFETY_ISLAND_CORESTATUS_OFFSET)
