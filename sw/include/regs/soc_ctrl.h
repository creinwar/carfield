...
#define CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_SPATZ_CLUSTER_FETCH_ENABLE_MASK 0x3
#define CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_SPATZ_CLUSTER_FETCH_ENABLE_OFFSET 0
#define CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_SPATZ_CLUSTER_FETCH_ENABLE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_SPATZ_CLUSTER_FETCH_ENABLE_MASK, .index = CARFIELD_SPATZ_CLUSTER_FETCH_ENABLE_SPATZ_CLUSTER_FETCH_ENABLE_OFFSET })
...
// Spatz Cluster busy
#define CARFIELD_SPATZ_CLUSTER_BUSY_REG_OFFSET 0xe4
#define CARFIELD_SPATZ_CLUSTER_BUSY_SPATZ_CLUSTER_BUSY_BIT 0

// PULP Cluster busy
#define CARFIELD_PULP_CLUSTER_BUSY_REG_OFFSET 0xe8
#define CARFIELD_PULP_CLUSTER_BUSY_PULP_CLUSTER_BUSY_BIT 0

// PULP Cluster end of computation
#define CARFIELD_PULP_CLUSTER_EOC_REG_OFFSET 0xec
#define CARFIELD_PULP_CLUSTER_EOC_PULP_CLUSTER_EOC_BIT 0

// L2 RAM cfg pins -margin adjustments-
#define CARFIELD_L2_SRAM_CONFIG0_REG_OFFSET 0xf0

// L2 RAM cfg pins -margin adjustments-
#define CARFIELD_L2_SRAM_CONFIG1_REG_OFFSET 0xf4

// L2 RAM cfg pins -margin adjustments-
#define CARFIELD_L2_SRAM_CONFIG2_REG_OFFSET 0xf8

// L2 RAM cfg pins -margin adjustments-
#define CARFIELD_L2_SRAM_CONFIG3_REG_OFFSET 0xfc
