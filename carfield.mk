...
car-hw-sim:
	$(QUESTA) vsim $(VSIM_FLAG) -do \
		"set CHS_BOOTMODE $(CHS_BOOTMODE); \
		 ...
		 set SPATZCL_BOOTMODE $(SPATZCL_BOOTMODE);\
...
.PHONY: spatz-hw-init
spatz-hw-init:
	$(MAKE) -C $(SPATZCL_MAKEDIR) -B SPATZ_CLUSTER_CFG=$(SPATZCL_MAKEDIR)/cfg/carfield.hjson bootrom
	cp  $(SPATZCL_ROOT)/sw/snRuntime/include/spatz_cluster_peripheral.h  $(CAR_SW_DIR)/include/regs/
