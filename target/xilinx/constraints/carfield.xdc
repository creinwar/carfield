...
# System Clock
create_generated_clock -name clk_soc -source [get_pins $MIG_CLK_SRC] -divide_by 4 [get_pins i_sys_clk_div/clk_o]

# JTAG Clock
create_generated_clock -period $JTAG_TCK -name clk_jtag [get_ports jtag_tck_i]
