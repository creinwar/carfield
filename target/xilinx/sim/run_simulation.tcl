source ips/xlnx_mig_ddr4_carfield_ex/questa/compile.do
source ips/xlnx_mig_ddr4/questa/compile.do
source ../scripts/add_sources_vsim.tcl


vlog -work work -L xil_defaultlib -64 -incr -sv "./ips/xlnx_mig_ddr4_carfield_ex/questa/srcs/sim_tb_top.sv"
